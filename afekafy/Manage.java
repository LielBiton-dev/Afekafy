...
public class Manage {
    ...
    public void printUserDetails(int userId) {
        try {
            ...
            if (rs.next()) {
                ...
                // Print user details in a cleaner format
    ...
    public void printArtists(int userID) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                System.out.println("Number of Albums: " + numOfAlbums);
    ...
    public void printArtistAlbums(int userId) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                System.out.println("Album Name: " + album.albumTitle);
                System.out.println("Genre: " + album.genre);
                System.out.println("Release Year: " + album.releasedYear);
                System.out.println();
            }
    ...
    public void printAllSongs() {
        ...
        try {
        	Class.forName(JDBC_DRIVER);
            conn = DriverManager.getConnection(DB_URL, USER, PASS);
            pstmt = conn.prepareStatement("SELECT * FROM songs");
            ...
            while (rs.next()) {
                ...
                System.out.println("Genre: " + rs.getString("song_genre"));
                System.out.println("Replays: " + rs.getInt("replays"));
                System.out.println("Year: " + rs.getInt("song_release_year"));
    ...
    public void printUserPlaylists(int userId) {
        try {
            ...
            while (rs.next()) {
                ...
                String title = rs.getString("playlist_name");
                int creationYear = rs.getInt("creation_year");
                String permission = rs.getString("permissions");
                System.out.println("ID: " + playlistId + ", Title: " + title + ", Year: " + creationYear + ", Permission: " + permission);
            }
    ...
    public void printSongsInPlaylist(int playlistId) {
        try {
            ...
            while (rs.next()) {
                ...
                int replays = rs.getInt("replays");
                int releaseYear = rs.getInt("song_release_year");
                System.out.println("ID: " + songId + ", Title: " + title + ", Duration: " + duration +
                                   ", Genre: " + genre + ", Replays: " + replays + ", Year: " + releaseYear);
            }
    ...
    public void printAllReviews(int userId) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                System.out.println("User ID: " + reviewUserId);
                System.out.println("--------------------------");
            }
    ...
    public void searchMusicDatabase(Scanner s) {
        ...
        try {
            ...
            // Printing the results nicely formatted
