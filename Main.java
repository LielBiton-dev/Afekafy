...
public class Main {
        ...
        try (Scanner s = new Scanner(System.in)) {
            ...
            while (!exit) {
                if (currentUserID == -2) {
                    ...
                    exit = handleUserMenu(s, manage, site);
                    if (exit) {
    ...
    public static boolean handleUserMenu(Scanner s, Manage manage, Site site) throws SQLException, IOException {
        printUserMenu(manage, currentUserID);
        int choice = getUserChoice(s);
        return executeUserChoice(choice, s, manage, site);
    }
    ...
    public static boolean executeUserChoice(int choice, Scanner s, Manage manage, Site site) throws SQLException, IOException {
        ...
        switch (choice) {
            ...
            case 3:
                ...
                break;
            case 4:
                if (manage.addNewPlaylist(currentUserID, s)) {
            ...
            case 9:
                if (manage.isArtist(currentUserID)) {
                    ...
                    manage.printArtists(currentUserID);
                    manage.printAllReviews(currentUserID);
                }	
                break;
            case 10:
                if (manage.isArtist(currentUserID)) {
